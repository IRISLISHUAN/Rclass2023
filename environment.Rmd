...
```{r echo=FALSE, purl=F}
xfun::embed_file("C:/Users/IRIS/Documents/R_class/Rclass2023/reef_fish.xlsx")
```
...
setwd("C:/Users/IRIS/Documents/R_class/Rclass2023")
```
...
fish<-read.table ("reef_fish.txt",header = TRUE,sep="", dec=".")# long version
fish<-read.table("reef_fish.txt", TRUE, "",".")# short version
```
