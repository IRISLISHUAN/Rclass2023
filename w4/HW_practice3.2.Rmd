...
```{r}
# Create vectors for weight_before and weight_after
weight_before<- c(104, 95, 87, 77, 112)
weight_after<-c(96, 91, 81, 75, 118)

#Combine the vectors into a data frame
diet<-data.frame(
  before_diet = weight_before,
  after_diet = weight_after
)

#change the row names
subject_number <- paste("subject_", 1:5, sep = "")
rownames(diet) <- subject_number
